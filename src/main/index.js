...
function createWindow() {
  ...
  mainWindow = new BrowserWindow({
    ...
    frame: false,
    webPreferences: { 
      webSecurity: false,//  当设置为 false, 它将禁用同源策略 (通常用来测试网站)
  ...
  // Open the DevTools.
  if (process.env.NODE_ENV === 'development') {
    // BrowserWindow.addDevToolsExtension('E:/work/testToods/vue-devtools-dev/vue-devtools-dev/shells/chrome')
}
